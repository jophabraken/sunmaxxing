...
NEIGHBORHOODS = [
    ...
    },
    {
        ...
        "title": "Biergärten in Neukölln — die sonnigsten Spots, live geprüft | Sonne Berlin",
...
def render_page(n: dict) -> str:
    ...
    article_schema = {
        ...
        "publisher": {
            "@type": "Organization", "name": "Sonne Berlin",
...
<nav class="breadcrumb" aria-label="Brotkrumen">
  <a href="/de/">Sonne Berlin</a><span class="sep">›</span><a href="/de/biergaerten-berlin/">Biergärten in Berlin</a><span class="sep">›</span><strong>{n['h1']}</strong>
</nav>
...
<footer>
  <p>Gebaut von <a href="/de/">Sonne Berlin</a> · <a href="/de/biergaerten-berlin/">Alle Berliner Biergärten</a></p>
