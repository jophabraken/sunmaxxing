...
def render_page(n: dict) -> str:
    ...
    article_schema = {
        ...
        "publisher": {"@type": "Organization", "name": "Sunmaxxing",
...
<nav class="breadcrumb" aria-label="Brotkrumen">
  <a href="/de/">Sunmaxxing</a><span class="sep">›</span><a href="/de/fruehstueck-berlin/">Frühstück in Berlin</a><span class="sep">›</span><strong>{n['h1']}</strong>
</nav>
...
<footer>
  <p>Gebaut von <a href="/de/">Sunmaxxing</a> · <a href="/de/fruehstueck-berlin/">Alle Berliner Frühstücks-Spots</a></p>
